...
class Zoom
{
    ...
    public static function createWebinar()
    {
        $curl = curl_init();
    ...
    public static function getListRegistree(){
        $curl = curl_init();

        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://api.zoom.us/v2/webinars/82521658333/registrants?occurrence_id=dolore%20in%20adipisicing%20culpa%20laborum&status=approved&page_size=30',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
